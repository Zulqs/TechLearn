<x-app-layout>
    ...
    <section class="container max-w-[1110px] text-black py-14">
        <div class="flex flex-row flex-wrap justify-between">
            ...
            <!-- Module Course Card -->
            <a href="{{url('/course/html')}}" class="flex flex-col w-[350px] border-2 rounded-lg hover:shadow-lg shadow-bgl my-5">
            ...
            <!-- Module Course Card -->
            <a href="{{url('/course/php')}}" class="flex flex-col w-[350px] border-2 rounded-lg hover:shadow-lg shadow-bgl my-5">
                <div class="flex flex-row justify-between rounded-t-lg bg-btr p-4">
            ...
            <!-- Module Course Card -->
            <a href="{{url('/course/kapasitor')}}" class="flex flex-col w-[350px] border-2 rounded-lg hover:shadow-lg shadow-bgl my-5">
                <div class="flex flex-row justify-between rounded-t-lg bg-btr p-4">
                    <h2 class="my-auto mr-4 font-bold text-2xl text-white">Mengenal Kapasitor</h2>
                    <img class="rounded-md" src="https://cerdika.com/wp-content/uploads/2020/01/Jenis-Kapasitor-760x570.jpg" alt="course_img" width="63px">
                </div>
                <div class="p-4">
            ...
            <!-- Module Course Card -->
            <a href="{{url('/course/switch')}}" class="flex flex-col w-[350px] border-2 rounded-lg hover:shadow-lg shadow-bgl my-5">
                <div class="flex flex-row justify-between rounded-t-lg bg-btr p-4">
            ...
            <!-- Module Course Card -->
            <a href="{{url('/course/router')}}" class="flex flex-col w-[350px] border-2 rounded-lg hover:shadow-lg shadow-bgl my-5">
                <div class="flex flex-row justify-between rounded-t-lg bg-btr p-4">
            ...
            <a href="{{url('/course/resistor')}}" class="flex flex-col w-[350px] border-2 rounded-lg hover:shadow-lg shadow-bgl my-5">
                <div class="flex flex-row justify-between rounded-t-lg bg-btr p-4">
