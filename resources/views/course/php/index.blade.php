<x-app-layout>
    ...
    <div class="container max-w-[1110px] bg-white rounded-lg shadow-sm">
        <div class="flex flex-col p-3 my-4 text-white">
            ...
            <a class="flex flex-row p-3 my-2 bg-btr rounded-lg" href="{{url('/course/php/1')}}">
                ...
                <div class="px-3 text-lg" >Perkenalann PHP</div>
            </a>
            <a class="flex flex-row p-3 my-2 bg-btr rounded-lg" href="{{url('/course/php/2')}}">
                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 19V4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v13H7a2 2 0 0 0-2 2Zm0 0a2 2 0 0 0 2 2h12M9 3v14m7 0v4"/>
                </svg>
                <div class="px-3 text-lg" >Install PHP</div>
            </a>
        </div>
    </div>
    ...
    <div class="container max-w-[1110px] bg-white rounded-lg shadow-sm">
        <div class="flex flex-col p-3 my-4 text-white">
            ...
            <a class="flex flex-row p-3 my-2 bg-btr rounded-lg" href="{{ route('quiz.show', 'php') }}">
                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 19V4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v13H7a2 2 0 0 0-2 2Zm0 0a2 2 0 0 0 2 2h12M9 3v14m7 0v4"/>
                </svg>
